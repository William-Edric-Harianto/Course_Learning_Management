<?php
    ...
    if(isset($_GET['update_student_id'])){
        ...
        $student=getStudentWithID($_GET['update_student_id']);
    }
?>
...
<body>
    <div class="container py-[1rem] px-[3rem]">
        <div class="bg-white border border-gray-200 rounded-lg shadow text-center">
            ...
            <div class="p-6 px-50">
                <h1 class="text-5xl my-[1rem] font-semibold">Update Student Data</h1>
                <form method="POST" action="../controller/controller.php">
                    ...
                    <button name="button_update_student" type="submit" class="px-4 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Update Student Data</button>
                </form>
            </div>
        </div>
