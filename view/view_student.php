        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow text-center">
            <div class="bg-gray-50 border-b border-gray-200 px-4 pt-3 rounded-t-lg">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center">
                    <li class="mr-2">
                        <a class="inline-block p-4 text-blue-600 bg-white border border-b-0 border-gray-200 rounded-t-lg active" href="#">Member List</a>
                    </li>
                    <li class="mr-2">
                        <a class="inline-block p-4 text-gray-500 hover:text-gray-600 hover:border-gray-300 rounded-t-lg" href="view_addmember.php">New Member</a>
                    </li>
                </ul>
            </div>
            <div class="p-6">
                <h1 class="text-5xl my-[2rem] font-semibold">Students</h1>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="py-[0.5rem]">
                                    <a href="view_update_student.php?updateID=<?= $index ?>">
                                    ...
                                    <a href="controller_member.php?deleteID=<?= $index ?>">
                                        <button name="button_delete" class="px-4 py-2 bg-red-500 text-white rounded-full hover:bg-red-600">Delete</button>
                                    </a>
                                </td>
                            </tr>
                        <?php
