        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow text-center">
            <div class="bg-gray-50 border-b border-gray-200 px-4 pt-3 rounded-t-lg">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center">
                    <li class="mr-2">
                        <a class="inline-block p-4 text-blue-600 bg-white border border-b-0 border-gray-200 rounded-t-lg active" href="../view/view_student.php">Student List</a>
                    </li>
                    <li class="mr-2">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="py-[0.5rem]">
                                    <a href="../view_update/view_update_student.php?update_student_id=<?= $index ?>">
                                        <button class="px-4 py-2 bg-green-500 text-white rounded-full hover:bg-green-600">Update</button>
                                    </a>
                                    <a href="../controller/controller.php?delete_student_id=<?= $index ?>">
